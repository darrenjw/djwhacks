...
\movie{\includegraphics[height=0.8\textheight]{dsrd2d}}{dsrd2d.mp4}
\end{center}
}
...
\movie{\includegraphics[height=0.8\textheight]{dsrd2d}}{sgrd2d.mp4}
\end{center}
}
...
\movie{\includegraphics[height=0.8\textheight]{dsrd2d}}{sgrd2dv3.mp4}
\end{center}
}
...
\movie{\includegraphics[height=0.8\textheight]{dsrd2d}}{sgrd2dv4.mp4}
\end{center}
}
