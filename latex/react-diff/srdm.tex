...
\begin{itemize}
\item Start by thinking separately about diffusion and reaction for every species in every subvolume --- $X_{i,n,t}$ is amount of species $i$ in subvolume $n$ at time $t$
\item Diffusion: $dX_{i,n,t} = D_i\Delta X_{i,n,t} dt + \sqrt{D_i}\left(\right)dW_{i,n,t}$
\item Reaction: 
