...
\date{Statistics Research Group Seminar\\Newcastle University\\26th October 2018}
...
%  \bibitem{} Elliott, C. (2017) \alert{Generic functional parallel algorithms: Scan and FFT}. \emph{ICFP 2017}, \textbf{1}:7.
  ...
  \bibitem{} Heunen, C., Kammar, O., Staton, S., Yang, H. (2017) \alert{A convenient category for higher-order probability thoery}, \emph{32nd Annual ACM/IEEE Symposium on Logic in Computer Science (LICS).}
