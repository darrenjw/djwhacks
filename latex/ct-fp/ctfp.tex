...
Given a log--likelihood for a single observation, one can create a function to evaluate the full log-liklihood that is completely \alert{parallelisation--agnostic}
