...
\title{A more functional future for statistical computing?}
...
\date{\textbf{APTS Statistical Computing}\\\emph{Cambridge University}\\14th December 2018}
...
\begin{frame}
  ...
  \item Concepts from \alert{category theory}, such as functors, monads, comonads, natural transformations and recursion schemes provide an appropriate array of tools for scalable data modelling and algorithm construction and composition
