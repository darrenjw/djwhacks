...
\item
  ...
  dawn of the computing age, and quite unsuitable for scalable and
...
\item
  ...
  also very poorly suited to the development of efficient, well-tested,
...
\item
  ...
  closed categories} provide an excellent foundation for scalable
...
\item
  ...
  languages (statically typed compiled functional programming languages with type
    inference and higher-kinded types) and algorithmic approaches (lazy transformation of immutable data structures with pure functions)
\end{itemize}
...
Web: \alert{\url{darrenjw.github.io}} \hfill Twitter: \url{@darrenjw}
