...
\frame{
  ...
  \item Everything!
    \pause
  \item \alert{R} has become the de facto standard programming language for statistical computing --- it was designed by statisticians for statisticians, and it shows!
    \begin{itemize}
