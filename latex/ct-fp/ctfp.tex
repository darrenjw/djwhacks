...
\title{Compositional approaches to scalable modelling and Bayesian computation}
\author{\textbf{\large Darren Wilkinson} \\
\url{@darrenjw}\hfill \alert{\url{darrenjw.github.io}}\\
\vspace{2ex}%
Durham University, UK}
\date{\textbf{Improbable Webinar}\\27th June 2022\\\mbox{}\hfill\alert{\url{github.com/darrenjw/talks}}
}
...
\item
  ...
  computationally intensive methods, such as MCMC, SMC or ABC --- similar
  structure to stochastic simulation models 
\item
...
\begin{frame}
  ...
  \begin{itemize}
  \item (WIP) repo containing code examples for RW MH, MALA, UL, and HMC MCMC algorithms for a Bayesian analysis of a logistic regression model
  \item Code in R, rjags, rstan, Python (with numpy), Python (with JAX), BlackJAX, numPyro, PyMC, Scala, Spark, Haskell, Julia, C, etc.
