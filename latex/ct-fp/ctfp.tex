...
\title{Monads for probabilistic programming}
...
\date{Statstics Research Group Seminar\\Newcastle University\\26th October 2018}
...
\begin{frame}[fragile]
\frametitle{Example --- logistic regression in Rainier}
\begin{lstlisting}[language=scala]
val model = for {
...
\begin{frame}[fragile]
  ...
  \item It would be nice to be able to define and compose probabilistic programmes independently of concerns about implementation, and then to \alert{interpret} the programme with a particular implementation later
