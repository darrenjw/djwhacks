...
\date{BIRS Workshop 18w5144\\Banff, Alberta, Canada\\12th November 2018}
...
%\item Likelihood-free MCMC for POMP models
...
\subsection{Overview of Bayesian methodology for stochastic dynamic models}
...
\item pMCMC not the only option worth considering --- \alert{ABC--SMC} methods, and \alert{SMC$^2$} are also worth trying; also \alert{iterated filtering} for a ML solution
...
\item nNew software library, written in Scala, replicating most of the functionality of the R packages in a fast, compiled, strongly typed, functional language
\end{itemize}
  }
