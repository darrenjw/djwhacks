...
%\title{A compositional approach to statistical computing, machine learning, and probabilistic programming}
...
\date{\textbf{APTS Statistical Computing}\\\emph{Online edition}\\December 2020}
